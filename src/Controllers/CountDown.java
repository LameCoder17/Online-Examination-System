...
public class CountDown {
    ...
    public HBox setCountdown() {
      ...
      one1.setStyle("-fx-font-size: 25px; -fx-text-fill: #ADEF31FF;");
      
      two2 = new Label(":");
      two2.setMaxHeight(50);
      two2.setStyle("-fx-font-size: 25px; -fx-text-fill: #ADEF31FF;");

      duration = Duration.minutes(settings.time);
    ...
    private Tile createTile(final String TEXT) {
        return TileBuilder.create().skinType(SkinType.CHARACTER)
                          ...
                          .textColor(Color.rgb(173,239,209))
                          .build();
    }
}
